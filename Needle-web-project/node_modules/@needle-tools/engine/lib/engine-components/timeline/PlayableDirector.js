...
export class PlayableDirector extends Behaviour {
    ...
    awake() {
        ...
        this.rebuildGraph();
        if (!this.isValid())
            console.warn("PlayableDirector is not valid", this.playableAsset, this.playableAsset?.tracks, Array.isArray(this.playableAsset?.tracks), this);
    }
    onEnable() {
    ...
    *internalUpdate() {
    ...
    setupAndCreateTrackHandlers() {
        ...
        AudioSource.registerWaitForAllowAudio(() => {
            const listener = GameObject.findObjectOfType(AudioListener, this.context);
            if (!listener)
                return;

...
export class RendererLightmap {
    ...
    lightmapScaleOffsetUniform = { value: new THREE.Vector4(1, 1, 0, 0) };
    ...
    init(lightmapIndex, lightmapScaleOffset, lightmapTexture, debug = false) {
    ...
    onBeforeRenderThreeComplete(_renderer, _scene, _camera, _geometry, material, _group) {

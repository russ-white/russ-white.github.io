...
(function (PeerMessage) {
    PeerMessage["Update_ID"] = "peer-update-id";
...
var PeerDebugOptions;
(function (PeerDebugOptions) {
    PeerDebugOptions[PeerDebugOptions["None"] = 0] = "None";
    PeerDebugOptions[PeerDebugOptions["Errors"] = 1] = "Errors";
    PeerDebugOptions[PeerDebugOptions["ErrorsAndWarnings"] = 2] = "ErrorsAndWarnings";
    PeerDebugOptions[PeerDebugOptions["All"] = 3] = "All";
})(PeerDebugOptions || (PeerDebugOptions = {}));
class PeerConnection {
    ...
    peerId;
    call = null;
    callErrorListener = null;
    stream = null;
    constructor(voip, peer, userId, peerId) {
        this.voip = voip;
        this.peer = peer;
        this.userId = userId;
        this.peerId = peerId;
...
class AudioConnection {
    ...
    get currentAnalyzer() { return this.analyzer; }
    voip;
    call;
    audio = null;
    stream = null;
...
export class Voip extends Behaviour {
    requireParam = false;
    set muteInput(value) {
        if (value === this._inputMuted)
            return;
        this._inputMuted = value;
        if (!this.currentIncomingCalls)
            return;
    ...
    set muteOutput(value) {
        if (value === this._outputMuted)
            return;
    ...
    getFrequency(userId) {
        ...
        if (userId === null) {
            for (const c in this.currentIncomingCalls) {
                ...
                if (call && call.currentAnalyzer)
                    return call.currentAnalyzer.getAverageFrequency();
            }
            return null;
        }
    ...
    awake() {
        ...
        this.context.connection.beginListen(PeerMessage.Update_ID, (cb) => {
    ...
    //     }
    // }
    static async HasMicrophonePermissions() {
        //@ts-ignore

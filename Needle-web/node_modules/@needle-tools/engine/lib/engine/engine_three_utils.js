...
import { WebGLRenderer, Vector3, Quaternion, Uniform, Texture, ShaderMaterial } from "three";
...
const _worldQuaternionBuffer = new THREE.Quaternion();
const _worldQuaternion = new THREE.Quaternion();
const _tempQuaternionBuffer2 = new THREE.Quaternion();
...
const _worldEulerBuffer = new THREE.Euler();
const _worldEuler = new THREE.Euler();
const _worldRotation = new THREE.Vector3();
...
export class Graphics {
    static planeGeometry = new THREE.PlaneGeometry(2, 2, 1, 1);
    static renderer = new WebGLRenderer({ antialias: false });
    static perspectiveCam = new THREE.PerspectiveCamera();
    ...
    static blipMaterial = new ShaderMaterial({
    ...
    static mesh = new THREE.Mesh(this.planeGeometry, this.blipMaterial);

 ...
 * }
 */
export declare function listTextureChannels(document: Document, texture: Texture): TextureChannel[];
/**
 ...
 * ```
 */
export declare function getTextureChannelMask(document: Document, texture: Texture): number;

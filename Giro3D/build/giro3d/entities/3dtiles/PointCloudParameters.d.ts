 ...
 * ```
 */
export type PointCloudBatchTableAttributeMapping = Record<WellKnown3DTilesPointCloudAttributes, string>;
export declare const DEFAULT_TILES3D_POINTCLOUD_ATTRIBUTE_MAPPING: PointCloudBatchTableAttributeMapping;
...
//# sourceMappingURL=PointCloudParameters.d.ts.map